...
public final class PreferencesFragment 
  ...
  public void onCreate(Bundle icicle) {
    ...
    checkBoxPrefs = findDecodePrefs(preferences,
                                    ZxingConstant.KEY_DECODE_1D_PRODUCT,
                                    ZxingConstant.KEY_DECODE_1D_INDUSTRIAL,
                                    ZxingConstant.KEY_DECODE_QR,
                                    ZxingConstant.KEY_DECODE_DATA_MATRIX,
                                    ZxingConstant.KEY_DECODE_AZTEC,
                                    ZxingConstant.KEY_DECODE_PDF417);
    disableLastCheckedPref();

    EditTextPreference customProductSearch = (EditTextPreference)
        preferences.findPreference(ZxingConstant.KEY_CUSTOM_PRODUCT_SEARCH);
