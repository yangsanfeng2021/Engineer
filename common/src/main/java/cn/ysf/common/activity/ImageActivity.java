...
import cn.ysf.common.image.ImageSelector;

@Route(path = RoutePath.COMMON_ACTIVITY_IMAGE)
public class ImageActivity extends BaseActivity implements View.OnClickListener {
    private static final int REQUEST_CODE = 1;
    private static final int PERMISSION_WRITE_EXTERNAL_REQUEST_CODE = 2;
...
//            Log.d("ImageSelector", "是否是拍照图片：" + isCameraImage);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_single) {//单选
            ImageSelector.builder()
                    .useCamera(true) // 设置是否使用拍照
                    .setSingle(true)  //设置是否单选
                    .canPreview(true) //是否点击放大图片查看,，默认为true
                    .start(this, REQUEST_CODE); // 打开相册
        } else if (id == R.id.btn_limit) {//多选(最多9张)
            ImageSelector.builder()
                    .useCamera(true) // 设置是否使用拍照
                    ...
                    .start(this, REQUEST_CODE); // 打开相册
        } else if (id == R.id.btn_unlimited) {//多选(不限数量)
            ImageSelector.builder()
                    .useCamera(true) // 设置是否使用拍照
                    .setSingle(false)  //设置是否单选
                    .canPreview(true) //是否点击放大图片查看,，默认为true
                    ...
                    .start(this, REQUEST_CODE); // 打开相册
        } else if (id == R.id.btn_clip) {//单选并剪裁
            ImageSelector.builder()
                    .useCamera(true) // 设置是否使用拍照
                    ...
                    .canPreview(true) //是否点击放大图片查看,，默认为true
                    .start(this, REQUEST_CODE); // 打开相册
        } else if (id == R.id.btn_only_take) {//仅拍照
            ImageSelector.builder()
                    .onlyTakePhoto(true)  // 仅拍照，不打开相册
                    .start(this, REQUEST_CODE);
        } else if (id == R.id.btn_take_and_clip) {//拍照并剪裁
            ImageSelector.builder()
                    .setCrop(true) // 设置是否使用图片剪切功能。
                    .setCropRatio(1.0f) // 图片剪切的宽高比,默认1.0f。宽固定为手机屏幕的宽。
                    .onlyTakePhoto(true)  // 仅拍照，不打开相册
