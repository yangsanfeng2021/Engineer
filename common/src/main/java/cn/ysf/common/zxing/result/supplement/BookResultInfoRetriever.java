...
package cn.ysf.common.zxing.result.supplement;
...
import cn.ysf.common.zxing.util.HttpUtils;
...
final class BookResultInfoRetriever extends SupplementalInfoRetriever {
  ...
  void retrieveSupplementalInfo() throws IOException {
    ...
    CharSequence contents = HttpUtils.downloadViaHttp("https://www.googleapis.com/books/v1/volumes?q=isbn:" + isbn,
